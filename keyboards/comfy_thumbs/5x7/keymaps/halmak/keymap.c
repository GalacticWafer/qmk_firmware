...
[_HALMAK] =  LAYOUT_ortho_5x7 (
        KC_ESC,  KC_W,     KC_L,    KC_R,    KC_B,    KC_Z,    KC_LBRC,  /**/    KC_RBRC, KC_SCLN, KC_Q,    KC_U,    KC_D,    KC_J,     KC_INS,
        /*NA*/   KC_S,     KC_H,    KC_N,    KC_T,    KC_COMM, KC_TAB,   /**/    KC_BSLS, KC_DOT,  KC_A,    KC_E,    KC_O,    KC_I,     KC_APP,
        /*NA*/   KC_F,     KC_M,    KC_V,    KC_C,    KC_X,    /*NA*/    /**/    /*NA*/   KC_G,    KC_P,    KC_SLSH, KC_K,    KC_Y,     KC_DEL,
